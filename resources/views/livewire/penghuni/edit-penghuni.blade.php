<div>
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form wire:submit.prevent="editPenghuni" enctype="multipart/form-data">
                    <div class="row">
                        <!-- Nama Lengkap -->
                        <div class="col-md-8">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select id="status_kontrak" wire:model.lazy="status_kontrak" class="form-control">
                                    <option value="Kontrak" {{ $status_kontrak == 'Kontrak' ? 'selected' : '' }}>Kontrak
                                    </option>
                                    <option value="Tetap" {{ $status_kontrak == 'Tetap' ? 'selected' : '' }}>Tetap
                                    </option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="status_menikah" wire:model.lazy="status_menikah" class="form-control">
                                    <option value="Menikah" {{ $status_menikah == 'Menikah' ? 'selected' : '' }}>Menikah
                                    </option>
                                    <option value="Belum Menikah"
                                        {{ $status_menikah == 'Belum Menikah' ? 'selected' : '' }}>Belum Menikah
                                    </option>
                                </select>
                            ...
                            <div class="form-group">
                                @if ($foto_ktp)
                                    <img src="{{ $foto_ktp->temporaryUrl() }}" style="width: 150px"
                                        ...
                                        id="showImage">
                                @elseif ($old_foto_ktp)
                                    <img src="{{ asset($old_foto_ktp) }}" style="width: 150px"
                                        class="rounded-circle avatar-lg img-thumbnail" alt="profile-image"
                                        id="showImage">
                                @else
                                    <img src="{{ url('no_image.jpg') }}" style="width: 150px"
                                        class="rounded-circle avatar-lg img-thumbnail" alt="profile-image"
                                        id="showImage">
                                @endif
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="status_iuran_bulanan" wire:model.lazy="status_iuran_bulanan" class="form-control">
                            <option value="Aktif" {{ $status_iuran_bulanan == 'Aktif' ? 'selected' : '' }}>Aktif
                            </option>
                            <option value="Tidak Aktif" {{ $status_iuran_bulanan == 'Tidak Aktif' ? 'selected' : '' }}>
                                Tidak Aktif</option>
                        </select>
